...
// Data functions for table references
...
function references_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		...
		$jsReadOnly .= "\tjQuery('#reference_name').replaceWith('<p class=\"form-control-static\" id=\"reference_name\">' + (jQuery('#reference_name').val() || '') + '</p>');\n";
