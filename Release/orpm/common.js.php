...
function applications_leases_validateData(){
	if($('status').value == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Application status", close: function(){ jQuery('#status').focus(); } }); return false; };
	if($('type').value == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Lease type", close: function(){ jQuery('#type').focus(); } }); return false; };
	if($('recurring_charges_frequency').value == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Recurring charges frequency", close: function(){ jQuery('#recurring_charges_frequency').focus(); } }); return false; };
	return true;
}
...
function applicants_and_tenants_validateData(){
	if($('status').value == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Status", close: function(){ jQuery('#status').focus(); } }); return false; };
	return true;
}
function properties_validateData(){
	if($('property_name').value == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Property Name", close: function(){ jQuery('#property_name').focus(); } }); return false; };
