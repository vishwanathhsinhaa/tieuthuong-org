...
// Data functions for table rental_owners
...
function rental_owners_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		...
		$jsReadOnly .= "\tjQuery('#company_name').replaceWith('<p class=\"form-control-static\" id=\"company_name\">' + (jQuery('#company_name').val() || '') + '</p>');\n";
		...
		$jsReadOnly .= "\tjQuery('#primary_email').replaceWith('<p class=\"form-control-static\" id=\"primary_email\">' + (jQuery('#primary_email').val() || '') + '</p>');\n";
		$jsReadOnly .= "\tjQuery('#primary_email, #primary_email-edit-link').hide();\n";
		$jsReadOnly .= "\tjQuery('#alternate_email').replaceWith('<p class=\"form-control-static\" id=\"alternate_email\">' + (jQuery('#alternate_email').val() || '') + '</p>');\n";
	...
	// process combos
	$templateCode=str_replace('<%%COMBO(date_of_birth)%%>', ($selected_id && !$arrPerm[3] ? '<p class="form-control-static">' . $combo_date_of_birth->GetHTML(true) . '</p>' : $combo_date_of_birth->GetHTML()), $templateCode);
